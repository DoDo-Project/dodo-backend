...
class BoardControllerTest {
    ...
    void tempSaveBoard_Success() {
        ...
        BoardTempSaveRequest request = BoardTempSaveRequest.builder()
                ...
                .imageFileUrls(List.of("https://example.com/images/bori.jpg"))
                .build();
        ...
        given(boardService.tempSaveBoard(userId, request)).willReturn(serviceResponse);

        // when
        ResponseEntity<BoardTempSaveResponse> response = boardController.tempSaveBoard(request, userDetails);
        ...
        verify(boardService).tempSaveBoard(userId, request);
