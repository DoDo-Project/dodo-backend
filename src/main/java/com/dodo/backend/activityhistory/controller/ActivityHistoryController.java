...
public class ActivityHistoryController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "활동을 기록할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "활동을 기록할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"활동을 기록할 권한이 없습니다.\"}"))),
            @ApiResponse(responseCode = "409", description = "진행 중인 활동 기록이 이미 존재합니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "진행 중인 활동 기록이 이미 존재합니다.", value = "{\"status\": 409, \"message\": \"진행 중인 활동 기록이 이미 존재합니다.\"}"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "활동을 시작할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "활동을 시작할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"활동을 시작할 권한이 없습니다.\"}"))),
            @ApiResponse(responseCode = "404", description = "해당 활동 기록을 찾을 수 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 활동 기록을 찾을 수 없습니다.", value = "{\"status\": 404, \"message\": \"해당 활동 기록을 찾을 수 없습니다.\"}"))),
            @ApiResponse(responseCode = "409", description = "이미 활동기록이 진행중입니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "이미 활동기록이 진행중입니다.", value = "{\"status\": 409, \"message\": \"이미 활동기록이 진행중입니다.\"}"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류가 발생했습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "서버 내부 오류가 발생했습니다.", value = "{\"status\": 500, \"message\": \"서버 내부 오류가 발생했습니다.\"}")))
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "해당 활동 기록을 중단할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 활동 기록을 중단할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"해당 활동 기록을 중단할 권한이 없습니다.\"}"))),
            @ApiResponse(responseCode = "404", description = "해당 활동 기록을 찾을 수 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 활동 기록을 찾을 수 없습니다.", value = "{\"status\": 404, \"message\": \"해당 활동 기록을 찾을 수 없습니다.\"}"))),
            @ApiResponse(responseCode = "409", description = "이미 종료된 활동 기록입니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "이미 종료된 활동 기록입니다.", value = "{\"status\": 409, \"message\": \"이미 종료된 활동 기록입니다.\"}"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류가 발생했습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "서버 내부 오류가 발생했습니다.", value = "{\"status\": 500, \"message\": \"서버 내부 오류가 발생했습니다.\"}")))
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "이미 종료된 활동 기록입니다, 아직 기록을 시작하지 않은 활동입니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "이미 종료된 활동 기록입니다, 아직 기록을 시작하지 않은 활동입니다.", value = "{\"status\": 409, \"message\": \"이미 종료된 활동 기록입니다, 아직 기록을 시작하지 않은 활동입니다.\"}"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류가 발생했습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "서버 내부 오류가 발생했습니다.", value = "{\"status\": 500, \"message\": \"서버 내부 오류가 발생했습니다.\"}")))
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "해당 활동 기록을 삭제할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 활동 기록을 삭제할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"해당 활동 기록을 삭제할 권한이 없습니다.\"}"))),
            @ApiResponse(responseCode = "404", description = "해당 활동 기록을 찾을 수 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 활동 기록을 찾을 수 없습니다.", value = "{\"status\": 404, \"message\": \"해당 활동 기록을 찾을 수 없습니다.\"}"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "요청한 페이지를 찾을 수 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "요청한 페이지를 찾을 수 없습니다.", value = "{\"status\": 404, \"message\": \"요청한 페이지를 찾을 수 없습니다.\"}"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류가 발생했습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "서버 내부 오류가 발생했습니다.", value = "{\"status\": 500, \"message\": \"서버 내부 오류가 발생했습니다.\"}")))
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "주변 활동 기록을 조회할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "주변 활동 기록을 조회할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"주변 활동 기록을 조회할 권한이 없습니다.\"}"))),
            @ApiResponse(responseCode = "404", description = "잘못된 요청입니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "잘못된 요청입니다.", value = "{\"status\": 404, \"message\": \"잘못된 요청입니다.\"}"))),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류가 발생했습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "서버 내부 오류가 발생했습니다.", value = "{\"status\": 500, \"message\": \"서버 내부 오류가 발생했습니다.\"}")))
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "해당 활동 기록을 조회할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 활동 기록을 조회할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"해당 활동 기록을 조회할 권한이 없습니다.\"}"))),
            @ApiResponse(responseCode = "404", description = "해당 ID의 활동 기록을 찾을 수 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 ID의 활동 기록을 찾을 수 없습니다.", value = "{\"status\": 404, \"message\": \"해당 ID의 활동 기록을 찾을 수 없습니다.\"}"))),
            @ApiResponse(responseCode = "409", description = "이미 종료된 활동 기록입니다, 아직 기록을 시작하지 않은 활동입니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "이미 종료된 활동 기록입니다, 아직 기록을 시작하지 않은 활동입니다.", value = "{\"status\": 409, \"message\": \"이미 종료된 활동 기록입니다, 아직 기록을 시작하지 않은 활동입니다.\"}"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "해당 반려동물의 정보를 조회할 권한이 없습니다.",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(name = "해당 반려동물의 정보를 조회할 권한이 없습니다.", value = "{\"status\": 403, \"message\": \"해당 반려동물의 정보를 조회할 권한이 없습니다.\"}"))),
